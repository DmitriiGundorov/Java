...
//Условие задачи. Подумать над структурой класса Ноутбук для магазина техники - выделить поля и методы. Реализовать в java.
...
public class Task_1 {
    public Task_1() {
        ...
        laptopsDB.add(new Notebook("14\" Ноутбук DEXP Aquilon серебристый [Full HD (1920x1080), IPS, Intel Celeron N4020, ядра: 2 х 1.1 ГГц, RAM 4 ГБ, SSD 128 ГБ, Intel UHD Graphics 600, Windows 11 Pro]"));
        laptopsDB.add(new Notebook("15.6\" Ноутбук Acer Aspire 1 A115-32-P859 серебристый [Full HD (1920x1080), TN+film, Intel Pentium Silver N6000, ядра: 4 х 1.1 ГГц, RAM 8 ГБ, eMMC 128 ГБ, Intel UHD Graphics, Windows 10 Pro]"));
        laptopsDB.add(new Notebook("15.6\" Ноутбук Lenovo IdeaPad 3 15ADA05 серый [HD (1366x768), TN+film, AMD Athlon Silver 3050U, ядра: 2 х 2.3 ГГц, RAM 4 ГБ, HDD 1000 ГБ, AMD Radeon Graphics, без ОС]"));
